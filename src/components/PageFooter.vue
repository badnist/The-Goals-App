  ...
  <footer class="page-footer">
    <div class="footer-text">
      ...
      <ul class="footer-links">
        ...
        <li>
          <a href="https://github.com/badnist/Ironhack-Frontend-Final-Project" target="_blank"
            class="discreet-anchor semi-discreet-anchor">GitHub</a>
        </li>
        <li>
          <a href="https://github.com/badnist" target="_blank" class="discreet-anchor semi-discreet-anchor">Author</a>
        </li>
      </ul>
    </div>
